// ignore_for_file: prefer_typing_uninitialized_variables, use_build_context_synchronously, must_be_immutable, unused_element

import 'package:custom_radio_grouped_button/custom_radio_grouped_button.dart';
import 'package:flutter/material.dart';
import 'package:flutter_application_1/models/konstituen.dart';
...
class DetailKonstituenPage extends StatefulWidget {
  final Konstituen konstituen;
  const DetailKonstituenPage(this.konstituen, {super.key});

  @override
  State<DetailKonstituenPage> createState() => _DetailKonstituenPageState();
}

class _DetailKonstituenPageState extends State<DetailKonstituenPage> {
                    ...
                    child: Column(
                      children: [
                        ...
                        _switchWidget(
                          ...
                          ['LAKI-LAKI', 'PEREMPUAN'],
                          ['L', 'P'],
                          widget.konstituen.jenisKelamin ?? 'L',
                          (value) {
                        ...
                        _switchWidget(
                          ...
                          ['Tinggi', 'Sedang', 'Rendah'],
                          widget.konstituen.markName ?? 'Rendah',
                          (value) {
                        ...
                        //     final berhasil = await dpt.updateDpt(
                        ...
                        //     } else {
                        //       showFailedDialog(
                        //           context, dpt.errorUpdateKonstituen.value);
                        //     }
                        //   });
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextField(
            ...
            readOnly: true,
            onTap: () {
              // openDialogWilayah(daftar, context, id, controller, title);
            },
            decoration: InputDecoration(
                // labelText: title,
                hintText: title,
  ...
  void openDialogWilayah(List<dynamic> daftar, BuildContext context, int id,
