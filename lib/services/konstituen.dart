...
class DPTService extends GetxController {
  ...
  final RxList<Konstituen> konstituenList = <Konstituen>[].obs;
  final RxList<Konstituen> konstituenListSearch = <Konstituen>[].obs;
  final RxBool isLoading = false.obs;
  final Rx<Konstituen?> konstituenData = Rx<Konstituen?>(null);
  ...
  Future<void> getDpt(int page) async {
    try {
      isLoading(true);
      ...
      if (response.statusCode == 200) {
        ...
        konstituenList.addAll(currentPageKonstituenList);
        isLoading(false);
      }
  ...
  void _scrollListener() {
    if (scrollController.position.pixels ==
      ...
      // Scroll mencapai akhir halaman, panggil halaman berikutnya
      loadNextPage();
    }
  }
